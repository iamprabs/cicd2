...
sfdx force:source:deploy --sourcepath force-app -u DevHub

echo "Testing code in org"
sfdx force:apex:test:run --testlevel RunLocalTests --outputdir test-results --resultformat tap -u DevHub
